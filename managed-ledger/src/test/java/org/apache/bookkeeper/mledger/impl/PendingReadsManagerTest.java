...
public class PendingReadsManagerTest  {
    ...
    EntryCacheImpl rangeEntryCache;
    ...
    void setupMocks() {
        rangeEntryCache = mock(EntryCacheImpl.class);
    ...
    private PreparedReadFromStorage prepareReadFromStorage(ReadHandle lh, EntryCacheImpl rangeEntryCache,
